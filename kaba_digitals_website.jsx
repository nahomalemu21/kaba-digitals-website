...
const services = [
  {
    ...
    description:
      "We create business videos, product videos, reels, testimonials, event coverage, and edited content that helps customers understand and trust your business.",
  ...
  },
  {
    ...
    description:
      "We set up and manage ads that put your business in front of people who are more likely to call, message, visit, or buy.",
  ...
  },
  {
    ...
    description:
      "We build clean, mobile-friendly websites and landing pages that explain what you do, show your work, and make it easy for customers to reach you.",
  ...
  },
  {
    ...
    description:
      "For businesses that want ongoing support, we manage content, ads, reports, and monthly improvements so your digital presence keeps moving.",
...
function Arrow() {
  return <span className="inline-block transition group-hover:translate-x-1">→</span>;
}
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/75 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
          ...
          <a href="#contact" className="hidden rounded-full bg-yellow-400 px-5 py-3 text-sm font-black text-black transition hover:bg-yellow-300 lg:inline-flex">
            Start a Project
          </a>

          <button onClick={() => setMenuOpen(!menuOpen)} className="rounded-xl border border-white/10 p-2 text-white lg:hidden" aria-label="Open menu">
            {menuOpen ? "✕" : "☰"}
          </button>
        </nav>
        ...
        <section className="mx-auto grid min-h-[88vh] max-w-7xl items-center gap-12 px-5 py-20 md:px-8 lg:grid-cols-[1.02fr_0.98fr] lg:py-28">
          <div className="animate-[fadeUp_.7s_ease-out]">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-yellow-300/30 bg-yellow-300/10 px-4 py-2 text-sm font-bold text-yellow-200">
              ✦ Video. Websites. Ads. Growth.
            </div>

            <h1 className="max-w-5xl text-5xl font-black leading-[0.95] tracking-[-0.06em] text-white md:text-7xl lg:text-8xl">
              Make your business look trusted online.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-300 md:text-xl">
              Kaba Digitals helps Ethiopian businesses grow with professional videos, modern websites, online ads, and monthly digital management.
            </p>

            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <a href="#contact" className="group inline-flex items-center justify-center gap-3 rounded-full bg-yellow-400 px-7 py-4 text-base font-black text-black transition hover:bg-yellow-300">
                Start Your Project <Arrow />
              </a>
              <a href="#services" className="inline-flex items-center justify-center gap-3 rounded-full border border-white/15 bg-white/5 px-7 py-4 text-base font-bold text-white transition hover:border-yellow-300/50 hover:bg-yellow-300/10">
                See Services
              </a>
            </div>
              ...
              {services.map((service) => (
                <div key={service.title} className="group rounded-[2rem] border border-white/10 bg-zinc-950 p-6 transition hover:-translate-y-1 hover:border-yellow-300/40 hover:bg-zinc-900">
                  ...
                  <ul className="mt-6 space-y-3">
                    {service.items.map((item) => <li key={item} className="flex items-center gap-3 text-sm text-zinc-300"><Check /> {item}</li>)}
                  </ul>
                </div>
              ))}
            </div>
        ...
        <section className="px-5 py-24 md:px-8">
          <div className="mx-auto max-w-7xl"><SectionHeader eyebrow="FAQ" title="Clear answers for serious clients." />
            <div className="mx-auto grid max-w-4xl gap-4">
              {[["Do you only make videos?", "No. Video is one of our main services, but we also build websites, landing pages, ads, social media management, and monthly digital growth plans."], ["Can you manage our social media every month?", "Yes. We can plan content, create posts, manage ads, and send monthly reports depending on the package."], ["Do you work with small businesses?", "Yes, but the business must be serious about improving its online presence. We can start simple and grow step by step."], ["How do we start?", "Send us your business name, what you sell, your goal, and what service you need. We will review and recommend the right plan."]].map(([q, a]) => (
